        ...
        <div className="min-h-screen bg-sky-50">
            <div className="max-w-7xl mx-auto w-full mt-35">
                ...
                <div className="flex justify-between">
                    ...
                    <button
                        className="bg-sky-500 py-2 px-6 text-white font-bold rounded-lg mb-3"
                ...
                <table className="w-full">
                    <thead className="bg-sky-300 text-gray-700">
                        <tr>
                            <th className="py-3 text-left px-3">
                                Full Name
                            </th>
                            ...
                            >
                                ...
                                <td>
                                    <Link
                                        ...
                                        className="bg-green-500 py-2 px-6 rounded-lg text-white hover:bg-green-300 transition-colors"
                                    >
                                        Update
                                    </Link>
                                </td>
                                ...
                                <td>
                                    <button
                                        onClick={() =>
                                            handleDelete(customer.National_Id)
                                        }
                                        className="bg-red-500 py-2 px-6 rounded-lg text-white hover:bg-red-300 transition-colors"
                                    >
                                        Delete
                                    </button>
                                </td>
